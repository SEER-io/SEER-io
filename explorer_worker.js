...
<body>
    <div class="container">
        ...
        <div class="grid" id="dashboard">
            ...
            <div class="stat-box">
                <span class="stat-label">Staking Lock</span>
                <span class="stat-value" id="staking">0.00%</span>
            </div>
            <div class="stat-box">
                <span class="stat-label">Market Cap Proxy</span>
                <span class="stat-value" id="mcap">$0.00M</span>
            </div>
        </div>
    ...
    <script>
        async function updateStats() {
            try {
                ...
                document.getElementById('staking').textContent = ((data.staking_ratio || 0.15) * 100).toFixed(2) + '%';
                document.getElementById('mcap').textContent = '$' + ((data.market_cap || 0) / 1000000).toFixed(2) + 'M';
